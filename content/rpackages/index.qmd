---
title: "R Packages for Health Metrics, Data Visualization, and Teaching"
description: "R packages by Federica Gazzelloni for health metrics, ecological data, spatial analysis, data visualization, and reproducible teaching workflows."
listing:
  contents: posts
  sort: "date desc"
  type: default
...
This section collects R packages by Federica Gazzelloni for health metrics, ecological data, data visualization, spatial analysis, and teaching workflows. It is designed as a practical entry point for people looking for reproducible R tools, examples, documentation, and source code connected to applied analytics.
...
-   [`{oregonfrogs}`](posts/oregonfrogs/): A package for analyzing and visualizing Oregon frog population data.
-   [`{hmsidwR}`](posts/hmsidwR/): Tools for health metrics data collection as long as extra tools for unzipping data and for spatial interpolation using inverse distance weighting.
-   [`{typeR}`](posts/typeR/): A package providing utilities for working with type-safe data structures in R providing live coding simulations.
