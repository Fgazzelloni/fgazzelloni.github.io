---
title: "Health Index with IHME Life Expectancy Data in R"
description: "R project building a health index from IHME Global Burden of Disease life expectancy data and population health indicators."
...
:::: columns
::: {.column width="60%"}
This project builds a health index in R using life expectancy data from the IHME Global Burden of Disease study. The aim is to turn population health indicators into a clearer comparative measure that can support health metrics analysis and reproducible public health workflows.
