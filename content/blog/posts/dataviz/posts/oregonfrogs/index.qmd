---
title: "Oregon Spotted Frog Data Visualization in R"
description: "R data visualization tutorial using TidyTuesday Oregon spotted frog data, custom plots, spatial context, and package workflows."
...
This tutorial visualizes Oregon spotted frog data in R using the TidyTuesday dataset and related `{oregonfrogs}` package workflow. It combines ecological data, spatial context, model output, and custom plotting to communicate patterns in frog survey observations.
