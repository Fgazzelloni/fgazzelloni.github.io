---
title: "Retail Sales Streamgraph in R with ggstream"
description: "R data visualization tutorial creating a retail sales streamgraph with ggstream, TidyTuesday data, tidyverse, and custom styling."
...
This tutorial creates a retail sales streamgraph in R with `{ggstream}` and TidyTuesday monthly state retail sales data. It focuses on tidyverse data preparation, visual design choices, and custom styling for a polished data visualization workflow.
...
<center>
![Retail Sales with ggstream](featured.png)
</center>
