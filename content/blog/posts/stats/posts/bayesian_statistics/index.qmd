...
description: "Bayesian statistics tutorial in R comparing model packages, prior distributions, likelihoods, and posterior inference."
date: '2023-03-22'
image: featured.png
...
::: {.column width="40%"}
![Bayesian Statistics](featured.png){width="400px"}
:::
:::
...
#| output: false
library(bayesrules)
plot_beta_binomial(alpha = 5, beta = 10, y = 26, n = 30)+
  theme_bw()
```
