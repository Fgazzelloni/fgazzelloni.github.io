...
description: "R text analysis tutorial using R-Ladies Meetup event data, meetupr, tidytext, topic modelling, and word cloud visualization."
excerpt: "Statistics"
date: 2024-03-12
draft: false
images: featured.png
...
::: columns
::: {.column width="80%"}
This tutorial shows how to collect and analyze R-Ladies Meetup event data in R. It uses `{meetupr}`, tidy text methods, topic modelling, and word cloud visualization to explore chapter activity and event language across the R-Ladies community.
