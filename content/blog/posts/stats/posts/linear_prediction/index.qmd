---
title: "How geom_smooth Makes Linear Model Predictions in R"
description: "R tutorial comparing ggplot2 geom_smooth predictions with lm and predict using historical cholera deaths data."
date: '2024-02-26'
image: featured.png
...
::: columns
::: {.column width="80%"}
This tutorial explains how `ggplot2::geom_smooth()` makes linear model predictions in R. It compares the smoothed line from `geom_smooth(method = "lm")` with explicit `lm()` and `predict()` output using historical cholera deaths data.
