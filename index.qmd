---
description: "Federica Gazzelloni's data science hub for R, Python, health metrics, infectious disease analytics, data visualization, books, podcasts, and projects."
listing:
  contents: content
  sort: "date desc"
  type: grid
